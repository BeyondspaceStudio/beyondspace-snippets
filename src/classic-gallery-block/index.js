...
(function docReady(fn) {
    ...
    loadjs([
        ...loadjsDeps,
    ], 'beyondspace-classic-gallery-block-deps');

    loadjs.ready('beyondspace-classic-gallery-block-deps', function() {
        debugMode && console.log('loaded');

        loadjs([
            debugMode ? 'https://localhost:3000/static/js/bundle.js' : 'https://static.beyondspace.studio/classic-gallery-block/main.js?t=' + Date.now(),
