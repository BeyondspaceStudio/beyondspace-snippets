...
(function docReady(fn) {
    ...
    const deps = [{
        ...
        depsCheck: () => typeof rangy !== 'undefined' && rangy?.hasOwnProperty('initialized'),
    }];
    ...
    loadjs.ready('beyondspace-emoji-picker-deps', function() {
        ...
        loadjs([
            debugMode ? 'https://localhost:3000/static/js/bundle.js' : 'https://static.beyondspace.studio/emoji-selector/main.js?t=' + Date.now(),
