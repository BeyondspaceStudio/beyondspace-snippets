...
(function docReady(fn) {
    ...
    const deps = [{
        ...
        path: 'https://cdn.jsdelivr.net/npm/dayjs-with-plugins@1.0.3/dist/dayjs-with-plugins.min.js',
        depsCheck: () => typeof dayjs !== 'undefined',
    }];
    ...
    loadjs([
        ...loadjsDeps,
    ], 'beyondspace-date-format-deps');

    loadjs.ready('beyondspace-date-format-deps', function() {
        debugMode && console.log('deps loaded');
        
        loadjs([
            debugMode ? 'https://localhost:3000/static/js/bundle.js' : 'https://beyondspace-admin.pages.dev/date-format/main.js?t=' + Date.now(),
        ], 'beyondspace-date-format');
    });
});
