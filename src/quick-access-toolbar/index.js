...
(function docReady(fn) {
    ...
    const deps = [{
        ...
        path: 'https://jsuites.net/v4/jsuites.js',
        depsCheck: () => false,
    },{
        path: 'https://jsuites.net/v4/jsuites.css',
        depsCheck: () => false,
    },{
        path: 'css!https://fonts.googleapis.com/icon?family=Material+Icons',
        depsCheck: () => false,
    }];
    ...
    loadjs.ready('beyondspace-quick-access-toolbar-deps', function() {
        ...
        loadjs([
            debugMode ? 'http://localhost:3000/static/js/bundle.js' : 'https://beyondspace-admin.pages.dev/quick-access-toolbar/main.js?t=' + Date.now(),
        ], 'foobar');
    });
});
